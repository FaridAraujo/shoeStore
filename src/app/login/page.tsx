    ...
    >
      ...
      <div>
        ...
        >
          ...
          COMPRÁ.<br />
          VIVÍ LA<br />
          <span style={{ color: "#F2BF1A" }}>CULTURA.</span>
        </h2>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        >
          5 tiendas en Costa Rica.<br />
          Drops exclusivos. Cultura auténtica.
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Back link */}
          <motion.div variants={FORM_VARIANTS.item}>
            <Link
              href="/"
              className="font-body font-medium uppercase"
          ...
          {/* Heading */}
          <motion.div variants={FORM_VARIANTS.item} style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <h1
              className="font-display"
          ...
          >
            ...
            <motion.div variants={FORM_VARIANTS.item}>
              ...
              >
                {submitting ? <><Spinner /> INGRESANDO</> : "INICIAR SESIÓN"}
              </button>
            </motion.div>
          </form>
          ...
          {/* Footer note */}
          <motion.p
            variants={FORM_VARIANTS.item}
            className="font-body"
            style={{ fontSize: 13, color: "#8A8680" }}
          >
            ¿No tenés cuenta?{" "}
            <Link href="/registro" style={{ color: "#0A0A0A", textDecoration: "underline", textUnderlineOffset: 3 }}>
              Registrate
            </Link>
          </motion.p>
        </motion.div>
